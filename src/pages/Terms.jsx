...
const Terms = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms & Conditions — Light Up Africa</title>
        <meta
          name="description"
          content="Review the Terms & Conditions governing the use of Light-Up-Africa. Learn about acceptable use, intellectual property, liability limitations, third‑party links, and mission‑aligned content policies."
        />
        <meta
          name="keywords"
          content="Light Up Africa terms, Africa electrification terms, website terms and conditions, user agreement Africa energy"
        />
        <meta name="robots" content="noindex, follow" />
        <link rel="canonical" href="https://light-up-africa.com/terms" />
  ...
  {`
    {
      ...
      "url": "https://light-up-africa.com/terms",
      "description": "These Terms of Service outline the rules and conditions for using the Light Up Africa website and content.",
      "about": {
        "@type": "Organization",
  ...
  <meta property="og:title" content="Terms of Service — Light Up Africa" />
  <meta property="og:description" content="Review the Terms of Service governing the use of Light Up Africa’s website, content, and services." />
  <meta property="og:url" content="https://light-up-africa.com/terms" />
  <meta property="og:image" content="https://light-up-africa.com/og-home.jpg" />

  {/* Twitter */}
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Terms of Service — Light Up Africa" />
  <meta name="twitter:description" content="Review the Terms of Service governing the use of Light Up Africa’s website, content, and services." />
