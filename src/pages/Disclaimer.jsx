...
const Disclaimer = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Disclaimer — Light Up Africa</title>
        <meta
          name="description"
          content="Read the official Light-Up-Africa Disclaimer outlining content limitations, accuracy, liability, external links, and advertising policies related to electrification and energy awareness across Africa."
        />
        <meta
          name="keywords"
          content="Light Up Africa disclaimer, Africa electrification disclaimer, energy information disclaimer, liability statement, content accuracy Africa"
        />
  ...
  {`
    {
      ...
      "@type": "WebPage",
      "name": "Disclaimer",
      "url": "https://light-up-africa.com/disclaimer",
      "description": "This Disclaimer explains the limitations of liability and informational intent of Light Up Africa content.",
      "about": {
        "@type": "Organization",
  ...
  <meta property="og:title" content="Disclaimer — Light Up Africa" />
  <meta property="og:description" content="Read the disclaimer outlining limitations of liability, accuracy, and usage of information provided by Light Up Africa." />
  <meta property="og:url" content="https://light-up-africa.com/disclaimer" />
  <meta property="og:image" content="https://light-up-africa.com/og-home.jpg" />

  {/* Twitter */}
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Disclaimer — Light Up Africa" />
  <meta name="twitter:description" content="Read the disclaimer outlining limitations of liability, accuracy, and usage of information provided by Light Up Africa." />
